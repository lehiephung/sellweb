...
<head>
    ...
    <link rel="stylesheet" href="./fonts/font/themify-icons-font/themify-icons/themify-icons.css">
...
<body>
    ...
    <div id="wrapper-login">
        <div id="wrapper">
            <form action="xulydangnhap.php" method="post" role="form">
                <h3>Đăng Nhập</h3>
                ...
                <a class="" href="dangki.php">Đăng Kí</a><br>
                <input type="submit" value="Đăng Nhập" name="dangnhap" id="btn-login"><br>
            </form>
        </div>
    </div>
    <div class="wrapper">
