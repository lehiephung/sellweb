                            ...
                            <div class="cart__desk__list">
                                <ul class="cart__price">
                                    <li><?php
                                        ...
                                        echo "<div class='total-price'>Giá trị đơn hàng: " . number_format($total) . ".000 Đ</div>";
                                        ?>
                                    <li>
                                        <?php

                                        $total1 = $total / 10;
                                        echo "<div class='total-price'>Thuế: " . number_format($total1) . ".000 Đ</div>";
                                        ?></li>
                                    ...
                                    <li>
                                        ...
                                        $total2 = $total1 + $total;
                                        echo "<div class='total-price'>Tổng giá trị đơn hàng: " . number_format($total2) . ".000 Đ</div>";
                                        ?></li>
                                </ul>

                                <ul class='payment__btn'>
                                    <li class='active'><a href='dangnhap.php'>Thanh Toán</a></li>
