...
{
    $sql = "select * from sanpham where chuyenmuc_id = $id LIMIT 8";
...
<?php
function display_product_rate($id, $conn)
{
        ...
        echo "<div class='col-lg-4 col-md-6 col-sm-6 col-xs-12'>
                <div class='htc__best__product'>
                    <div class='htc__best__pro__thumb'>
                        <a href='thongtinsp.php?id={$row['id']}'>
                            <img src='./img_product/{$row['hinhanh']}' alt='product images' width='183' height='250'>
                        </a>
                    </div>
                    <div class='htc__best__product__details'>
                        <h2><a href='thongtinsp.php?id={$row['id']}'>{$row['tensp']}</a></h2>
                        <ul class='rating'>
                                    ...
                                    <ul class="main__menu">
                                        ...
                                        <li class="drop"><a href="#">Tùy Chọn</a>
                                            <ul class="dropdown mega_dropdown">
                                                ...
                                                <li><a class="mega__title" href="product-grid.html">Trang mua sắm</a>
                                                    <ul class="mega__item">
                                        ...
                                        <li class="drop"><a href="product-grid.php">Sản Phẩm</a>
                                        </li>
            ...
            <div class="shopping__cart">
                <div class="shopping__cart__inner">
                    ...
                    <ul class="shopping__btn">
                        ...
                        <li class="shp__checkout"><a href="checkout.html">Thủ Tục Thanh Toán</a></li>
                    </ul>
                </div>
            </div>
            <!-- End Cart Panel -->
                        ...
                        <div class="row align-items__center">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="./img_product/prd5.jpg" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single__slide animation__style01 slider__fixed--height">
                    <div class="container">
                        <div class="row align-items__center">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="./img_product/pd9.jpg" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="section__title--2 text-center">
                            <h2 class="title__line">Sản Phẩm Mới Cập Nhật</h2>
                            <p>Hãy trải nghiệm, chúng sẽ không làm cậu phải thất vọng</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                        <div class="fr__prize__inner">
                            <h2>CỬA HÀNG THỜI TRANG ROUTINE.</h2>
                            <h3>Nơi mang đến niềm vui khi mua sắm.</h3>
                            <a class="fr__btn" href="#">Xem Thêm</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                        <div class="prize__inner">
                            <div class="prize__thumb">
                                <img src="images\banner\big-img\place.webp" alt="banner images">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="ftr__product__area ptb--100">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <div class="section__title--2 text-center">
                        <h2 class="title__line">Top Seller</h2>
                        <p>Nổi Bật Trong Năm 2024</p>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <section class="top__rated__area bg__white pt--100 pb--110">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section__title--2 text-center">
                        <h2 class="title__line">Xếp Hạng Đánh Giá</h2>
                        <p>Nơi Chất Lượng Được Đặt Lên Hàng Đầu</p>
                    </div>
                </div>
            </div>
            <div class="row mt--20">
                ...
                <?php
                display_product_rate(2, $conn);
                display_product_rate(5, $conn);
                display_product_rate(3, $conn);
                ?>
                <!-- End Single Product -->
            </div>
        </div>
