...
<div id="wrapper-login">
            <form action=""method=""role="form">
                 <h3>Quản Lý Admin</h3>
                 <div class="">                    
                     <button type ="button"class="button" onclick="location.href='sanpham.php'"><span>Sản Phẩm </span>
                    <button type ="button"class="button" onclick="location.href='user.php'"><span>User </span><br>                     
                 </div>
            </form>
